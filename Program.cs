...
namespace Assignment5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Test the Storage class with string
            ...
            // Test the Storage class with double
            ...
            // Test the Pair class with an integer and string
            Pair<int, string> pair1 = new Pair<int, string>(1, "One");
            pair1.PrintPair();

            // Test the Pair class with string and double
